...
const fabVariants = cva(
  "inline-flex items-center justify-center shadow-m3-3 hover:shadow-m3-4 transition-all duration-300 ease-[cubic-bezier(0.2,0,0,1)] active:scale-90 active:shadow-m3-3 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
