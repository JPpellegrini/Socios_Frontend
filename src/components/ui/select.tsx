          ...
          className={cn(
            ...
            variant === "filled"
              ...
              : [
                  ...
                  "peer-data-[has-value=true]:-translate-y-7 peer-data-[has-value=true]:scale-75 peer-data-[has-value=true]:bg-background peer-data-[has-value=true]:px-1",
                  "peer-focus:-translate-y-7 peer-focus:scale-75 peer-focus:bg-background peer-focus:px-1",
                  "peer-data-[state=open]:-translate-y-7 peer-data-[state=open]:scale-75 peer-data-[state=open]:bg-background peer-data-[state=open]:px-1",
                ]
          )}
        >
          {label}
